  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-[#888] text-sm">Edit your canonical CV. Run ATS audit to check compatibility. Paste in Markdown format.</p>
        <div className="flex gap-2">
          ...
          <button className="btn-primary" onClick={save} disabled={saving || !isDirty}>
            {saving ? "Saving…" : saved ? "Saved!" : isDirty ? "Save" : "No Changes"}
          </button>
        </div>
      </div>
